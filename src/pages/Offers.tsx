...
const Offers: React.FC = () => {
  ...
  const [statusFilter, setStatusFilter] = useState<
    "all" | "active" | "inactive"
  >("all");
  const [sortBy, setSortBy] = useState<"created" | "apr" | "utilization">(
    "created"
  );
  ...
  const filteredOffers = offers
    ...
    .sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case "utilization":
          aValue =
            (parseInt(a.currentExposure, 16) / parseInt(a.maxExposure, 16)) *
            100;
          bValue =
            (parseInt(b.currentExposure, 16) / parseInt(b.maxExposure, 16)) *
            100;
          break;
        default:
  ...
  const OfferModal: React.FC<{
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      await updateOffer({
        ...
        quoteToken:
          typeof offer.quoteToken === "string"
            ? offer.quoteToken
            : offer.quoteToken.address,
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="mt-2 text-center text-gray-600">
                Create your first lending offer to start earning interest on
                your assets.
              </p>
              <Link to="/create-offer">
                <Button variant="glass" size="sm">
