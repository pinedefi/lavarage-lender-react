...
export const getQuoteTokenAddress = (symbol: keyof typeof QUOTE_TOKENS): string => {
  return QUOTE_TOKENS[symbol].address;
};

// Export available quote token symbols
export const QUOTE_TOKEN_SYMBOLS = Object.keys(QUOTE_TOKENS) as Array<keyof typeof QUOTE_TOKENS>;
